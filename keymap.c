...
#define RGUI_COLN RGUI_T(KC_COLN)


const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_split_3x5_2(
        KC_Q      , KC_W      , KC_E      , KC_R      , KC_T      ,        KC_Y      , KC_U      , KC_I      , KC_O      , KC_P      ,
        LGUI_A    , LALT_S    , LCTL_D    , LSFT_F    , KC_G      ,        KC_H      , RSFT_J    , RCTL_K    , RALT_L    , RGUI_M    ,
        KC_Z      , KC_X      , KC_C      , KC_V      , KC_B      ,        KC_N      , KC_M      , KC_COMM   , KC_DOT    , KC_SLSH   ,
                                            MED_TAB   , NAV_SPC   ,        SYM_BSPC  , FNC_ENT
    ),
    [SYMBOL] = LAYOUT_split_3x5_2(
        KC_1      , KC_2      , KC_3      , KC_4      , KC_5      ,        KC_6      , KC_7      , KC_8      , KC_9      , KC_0      ,
        LGUI_LGRV , LALT_LCBR , LCTL_LBRC , LSFT_LPRN , KC_PLUS   ,        KC_ASTR   , RSFT_UNDS , RCTL_DQUO , RALT_QUOT , RGUI_COLN ,
        KC_BSLS   , KC_RCBR   , KC_RBRC   , KC_RPRN   , KC_MINS   ,        KC_SLSH   , KC_EQL    , KC_LT     , KC_GT     , KC_QUES   ,
                                            KC_ESC    , RGUI_COLN ,        XXXXXXX   , XXXXXXX
    ),
    ...
    [NAVIGATION] = LAYOUT_split_3x5_2(
        ...
        KC_CAPS   , KC_CUT    , KC_COPY   , KC_PSTE   , QK_BOOT   ,        XXXXXXX   , KC_HOME   , KC_PGDN   , KC_PGUP   , KC_END    ,
                                            XXXXXXX   , XXXXXXX   ,        XXXXXXX   , XXXXXXX
    ),
    [MEDIA] = LAYOUT_split_3x5_2(
        XXXXXXX   , XXXXXXX   , XXXXXXX   , XXXXXXX   , XXXXXXX   ,        XXXXXXX   , XXXXXXX   , KC_MRWD   , KC_MFFD   , XXXXXXX   ,
        XXXXXXX   , XXXXXXX   , XXXXXXX   , XXXXXXX   , XXXXXXX   ,        XXXXXXX   , KC_MPLY   , KC_VOLD   , KC_VOLU   , KC_MUTE   ,
